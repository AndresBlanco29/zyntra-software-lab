...
urlpatterns = [
    ...
    path('backoffice/<int:pedido_id>/devolver-picking/', views.backoffice_devolver_desde_picking, name='backoffice_devolver_desde_picking'),
    ...
    path('backoffice/inventory-needs/report/', views.backoffice_inventory_needs_report, name='backoffice_inventory_needs_report'),
