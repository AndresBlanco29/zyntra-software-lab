...
from config.core.migration_utils import CreateModelIfMissing
from django.conf import settings
from django.db import migrations, models


CREATE_COMPRA_PROVEEDOR = CreateModelIfMissing(
...
CREATE_COMPRA_PROVEEDOR_LINEA = CreateModelIfMissing(
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.SeparateDatabaseAndState(
            database_operations=[
                CREATE_COMPRA_PROVEEDOR,
                CREATE_COMPRA_PROVEEDOR_LINEA,
            ],
            state_operations=[
                migrations.CreateModel(
                    name='CompraProveedor',
                    fields=CREATE_COMPRA_PROVEEDOR.fields,
                    options=CREATE_COMPRA_PROVEEDOR.options,
                ),
                migrations.CreateModel(
                    name='CompraProveedorLinea',
                    fields=CREATE_COMPRA_PROVEEDOR_LINEA.fields,
                    options=CREATE_COMPRA_PROVEEDOR_LINEA.options,
                ),
            ],
        ),
    ]
