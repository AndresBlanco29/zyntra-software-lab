...
urlpatterns = [
	...
	path('backoffice/live-drivers/', views.backoffice_live_drivers, name='backoffice_live_drivers'),
	path('backoffice/live-drivers/data/', views.backoffice_live_drivers_data, name='backoffice_live_drivers_data'),
